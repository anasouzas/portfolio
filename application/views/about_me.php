                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                            <div class="mt-3">
                                <h4>Ana Souza</h4>
                                <p class="text-secondary mb-1">Computer Science Student | Programmer Intern</p>
                                <p class="text-muted font-size-sm">Belo Horizonte, Minas Gerais, Brazil</p>
                                <hr>
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                                        ...
                                        <span class="text-secondary">anasouzas</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
